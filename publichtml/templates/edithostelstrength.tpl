...
<body>
<form name=form action="index.php?service=EDITHOSTELSTRENGTH1" method="POST" onSubmit="return formateForm();">
...
<tr><td align=center colspan="4"><input type=submit value="VIEW"> </td></tr></table>
 <input name=service type=hidden value="EDITHOSTELSTRENGTH1" />
