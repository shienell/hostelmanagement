...
<body>
<form name=form action="index.php?service=DISPLAYFORM1" method="POST" onSubmit="return formateForm();" target="_new">
...
<tr><td align=center colspan="4"><input type=submit value="VIEW"> </td></tr></table>
 <input name=service type=hidden value="DISPLAYFORM1" />
