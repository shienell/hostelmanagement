...
<br><br>
  ...
  <table width="100%" align="left" bgcolor="#70A3D0" cellspacing="2">
   <tr>
   <th align="right"><h3 style="color:white">Item No&nbsp;:</th><td><input type="text" name="itemno" value="{$stockid}" readonly></td>
   <th align="right"><h3 style="color:white">Item Name&nbsp;:</th><td><input type="text" name="itemname" value=""></td>
   </tr>
   <tr><td><td></td></td></tr>
