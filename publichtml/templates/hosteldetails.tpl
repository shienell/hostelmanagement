...
<body>
<form name=form action="index.php?service=INSERTHOSTELDETAILS" method="POST" onSubmit="return formateForm();">
...
<tr><td align=center colspan="4"><input type=submit value="SUBMIT"> </td></tr></table>
 <input name=service type=hidden value="INSERTHOSTELDETAILS" />
