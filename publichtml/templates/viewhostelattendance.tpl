...
<body>
<form name=form action="index.php?service=VIEWHOSTELATTENDANCE1" method="POST" onSubmit="return formateForm();" target="_new">

<br><br>
  <h2 align="center"> {$message} </h3>
...
<tr><td align=center colspan="4"><input type=submit value="VIEW"> </td></tr></table>
 <input name=service type=hidden value="VIEWHOSTELATTENDANCE1" />
